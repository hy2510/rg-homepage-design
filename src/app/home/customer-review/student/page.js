...
import { studentsReflectionsData } from "@/components/modules/home-customer-review-components/sample-data";
import {
  Pagination,
  PaginationItem,
        ...
        {studentsReflectionsData.map((a) => {
          return (
            <BoardItem
              ...
              txt_td4={a.date}
              href={"/home/customer-review/student/content"}
            />
          );
        })}
      </Board>
